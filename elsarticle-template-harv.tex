...
%Such a system could become crucial to support anyone responsible for establishing and maintaining an advanced sensor network, including territorial bodies, researchers, and other stakeholders such as consortia of farmers.
...
Results obtained on scopus.com (May 2024) reveals that 386 documents (articles, reviews and books) were published on cyber infrastructures applied in (agro-)meteorology, while none of them were relevant to the peculiar scope of my work.
...
is proposed as a general technological framework being a WB-SDSS, that can be fully tailored to the specific needs of an existent sensors network, such as an agrometeorological network managed by local entrusted/responsible entities.
In this paper, "responsible entities" or "stakeholders" refer to local government agencies, researchers, consortia of farmers, and other similar entities involved in the management and use of agrometeorological data.
...
The work is presented following a hierarchical structure, starting from the most general to the most particular part.
...
%Focusing on false positives, the distribution of random noise added to raw measurements reveals that approximately 45% falls within the range $[0, ; \pm1]$, and around 47% falls within the range $[\pm1, ; \pm2]$.
...
The case study not only highlights the system's capacity for scaling across territories and networks but also emphasizes its potential in enhancing the accessibility of data from various IoT sensors for a wide range of applications.
