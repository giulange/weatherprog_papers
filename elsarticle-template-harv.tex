...
Once the \gci instance is created, the execution of different WeatherProg jobs must be arranged in a composite schedule to run %the procedure of handling agrometeorological data across 
different workflows.
...
%(results: \gci $-->$ WeatherProg $-->$ qcheck+infill)
